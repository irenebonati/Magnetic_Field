...
K_0_E      =  470e9           # Incompressibility at surface (Tachinami+2011, Table 1)
...
# unsure about value of K_0 (Labrosse seems to be using sth like K_0_E=470e9)
...
# From Lena's outputs (core)
# alpha = 1-2e-5
# Gruneisen = 1.2-1.3
# cp_c = 900-1300
# rho_c = 11000-15000 (rho at CMB) --. read rho_center from profiles (13000-18000)
...
Pc_Earth = calc_Pc(H_Earth,rho_c_E,c_E,L_T_Earth,I_Earth,C_p_E,T_sol0_E,gamma_E)
...
P_G_Earth = calc_P_G(Delta_rho_Earth,rho_c_E,c_E,b_E)


# ------------------------------ P_L=P_L(c) -----------------------------------

#P_L = calc_P_L(r_ICB,rho_ICB,T_sol_ICB,DeltaS)    

T_sol_Earth = calc_T_sol(gamma_E,c_E,L_T_Earth,T_sol0_E)

#P_L = calc_P_L(b_E,rho_ICB,T_sol_ICB,DeltaS) 
